 ...
 * @version 4.0.0-beta.3 Sun, 27 May 2018 07:38:15 GMT
...
(function () {
    ...
    var FAKE_ANIMATION_NAME = "v__40000-beta03__";
    var SHEET_PROP_NAME = "__40000-beta03__sheet";
    ...
    function document$index$$$Document(node) {
        if (this instanceof document$index$$$Document) {
            ...
            return node["__40000-beta03__"] || new document$index$$$Document(node);
        } else {
    ...
    function element$index$$$Element(node) {
        if (this instanceof element$index$$$Element) {
            ...
            // create a new wrapper or return existing object
            return node["__40000-beta03__"] || new element$index$$$Element(node);
        } else {
    ...
    node$index$$$Node.prototype.get = function (name, defaultValue) {
        ...
        if (hook) {
            ...
            value = name.reduce(function (memo, key) {
                return memo[key] = _this5.get(key), memo;
            }, {});
        } else {
