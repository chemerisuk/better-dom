/**
 * @file better-dom.js
 * @version 2.0.0-rc.3 2014-09-19T20:24:49
...
(function() {
    ...
    var constants$$LEGACY_IE = constants$$DOCUMENT.attachEvent && !constants$$WINDOW.CSSKeyframesRule;
    ...
    var dom$create$$reTest = /^(?:[a-z-]+|\s*(<.+>)\s*)$/i,
        dom$create$$sandbox = constants$$DOCUMENT.createElement("body"),
    ...
    var dom$importstyles$$styleNode = helpers$$default.injectElement(constants$$DOCUMENT.createElement("style")),
    ...
    var util$extensionhandler$$reRemovableMethod = /^(on|do)[A-Z]/,
        ...
        util$extensionhandler$$ExtensionHandler = function(selector, condition, mixins, index)  {
            var eventHandlers = helpers$$default.keys(mixins).filter(function(prop)  {return !!util$extensionhandler$$reRemovableMethod.exec(prop)}),
                ...
                ext = function(node, mock)  {
                    ...
                    if (mock === true || condition(el) !== false) {
                        helpers$$default.assign(el, mixins);
    ...
    if (constants$$LEGACY_IE) {
        util$extensionhandler$$ExtensionHandler.EVENT_TYPE = constants$$CUSTOM_EVENT_TYPE;
    } else {
        util$extensionhandler$$ExtensionHandler.ANIMATION_ID = util$extensionhandler$$ANIMATION_ID;
        util$extensionhandler$$ExtensionHandler.EVENT_TYPE = constants$$WEBKIT_PREFIX ? "webkitAnimationEnd" : "animationend";
    }
    ...
    if (constants$$LEGACY_IE) {
        var dom$extend$$link = constants$$DOCUMENT.querySelector("link[rel=htc]");

        if (dom$extend$$link) {
            dom$extend$$link = dom$extend$$link.href;
        } else {
            if ("console" in constants$$WINDOW) {
                constants$$WINDOW.console.log("WARNING: In order to use live extensions in IE < 10 you have to include extra files. See https://github.com/chemerisuk/better-dom#notes-about-old-ies for details.");
            }

            var dom$extend$$scripts = constants$$DOCUMENT.scripts;
        ...
        constants$$DOCUMENT.attachEvent("on" + util$extensionhandler$$default.EVENT_TYPE, function()  {
        ...
        var dom$extend$$readyState = constants$$DOCUMENT.readyState;
        // IE10 and lower don't handle "interactive" properly... use a weak inference to detect it
        // discovered by ChrisS here: http://bugs.jquery.com/ticket/12282#comment:15
        if (constants$$DOCUMENT.attachEvent ? dom$extend$$readyState !== "complete" : dom$extend$$readyState === "loading") {
            ...
            constants$$DOCUMENT.addEventListener("DOMContentLoaded", dom$extend$$readyCallback, false);
            // just in case the DOMContentLoaded event fails use onload
            constants$$WINDOW.addEventListener("load", dom$extend$$readyCallback, false);
        }

        dom$importstyles$$default("@" + constants$$WEBKIT_PREFIX + "keyframes " + util$extensionhandler$$default.ANIMATION_ID, "from {opacity:.99} to {opacity:1}");
        ...
        constants$$DOCUMENT.addEventListener(util$extensionhandler$$default.EVENT_TYPE, function(e)  {
    ...
    types$$DOM.extend = function(selector, condition, mixins) {
        ...
        if (selector === "*") {
            ...
            helpers$$default.assign(types$$$Element.prototype, mixins);
        } else {
            ...
            ext.start = function()  {
                ...
                helpers$$default.each.call(constants$$DOCUMENT.querySelectorAll(selector), ext);
    ...
    var dom$mock$$applyExtensions = function(node)  {
            ...
            helpers$$default.each.call(node.children, dom$mock$$applyExtensions);
        },
    ...
    types$$$Element.prototype.empty = function() {
    ...
    var element$find$$rquick = constants$$DOCUMENT.getElementsByClassName ? /^(?:(\w+)|\.([\w\-]+))$/ : /^(?:(\w+))$/,
                ...
                handler = function(e)  {
                    ...
                    args = args.map(function(name)  {
                        ...
                        if (!constants$$DOM2_EVENTS) {
                            ...
                            case "pageX":
                                return e.clientX + constants$$HTML.scrollLeft - constants$$HTML.clientLeft;
                            case "pageY":
    ...
    var element$on$$makeMethod = function(method)  {return function(type, selector, props, callback) {var this$0 = this;
        if (typeof type === "string") {
            ...
            if (helpers$$default.isArray(type)) {
                ...
                helpers$$default.keys(type).forEach(function(name)  { this$0[method](name, type[name]) });
            }
        } else {
    ...
    var element$visibility$$ANIMATIONS_ENABLED = !constants$$LEGACY_ANDROID && !constants$$LEGACY_IE,
        element$visibility$$TRANSITION_PROPS = ["timing-function", "property", "duration", "delay"].map(function(p)  {return "transition-" + p}),
        element$visibility$$TRANSITION_EVENT_TYPE = constants$$WEBKIT_PREFIX ? "webkitTransitionEnd" : "transitionend",
        element$visibility$$ANIMATION_EVENT_TYPE = constants$$WEBKIT_PREFIX ? "webkitAnimationEnd" : "animationend",
